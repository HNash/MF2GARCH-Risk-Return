...
\resizebox{\textwidth}{!}{
  \begin{tabular}{ccccccccccccc}
    ...
    \begin{tabular}[t]{@{}c@{}}0.842*** \\ (0.020)\end{tabular} &
    \begin{tabular}[t]{@{}c@{}}0.011 \\ (0.047)\end{tabular} &
...
\addcontentsline{toc}{subsection}{A.3{\quad}Notes on the use of Artificial Intelligence}
