...
For $\gamma$, $\beta$, $\lambda_1$, $\lambda_2$, $\delta_{1,l}$ and $\delta_1$, the estimates show little bias. The bias does not exceed $\pm1.50\%$ for any specification for these parameters. The estimates of the constants ($\alpha$, $\lambda_0$ and $\delta_0$) as well as the coefficient of the short-term component ($\delta_{1,s}$) show more severe bias, however. The estimates of $\alpha$ have an average bias of $19.37\%$, $\lambda_0$ an average bias of $6.86\%$, $\delta_0$ an average bias of $-9.50\%$ and $\delta_{1,s}$ an average bias of $-20\%$.\\
